      ...
      <div className='max-w-[1200px] mx-auto px-8 flex flex-col justify-center' style={{ color: colorScheme.textColor }}>
        <div className='flex flex-col md:flex-row items-center md:justify-between'>
          <div className='md:w-1/2.5'>
            <br/>
            <br/>
            <h1 className={`text-3xl sm:text-5xl font-bold text-${colorScheme.accentColor} ${isDarkMode ? 'text-white' : 'text-black'}`}>
              Hello everyone, Welcome !
              <br/>
            
            </h1>
            <p className={`py-2 max-w-[1200px] text-3xl ${isDarkMode ? 'text-red-500' : 'text-blue-900'}`}>
            My name is <b> Naveen Kumar Madasu</b> & <b> <span className={isDarkMode ? 'text-yellow-300' : 'text-red-500'}> <br/> I'm a Software Engineer (Front-End Developer)</span> </b>            
            </p>
