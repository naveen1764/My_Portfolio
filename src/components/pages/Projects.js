        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-10 ">
          <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
            ...
            <img src={Project1Img} alt="Property" className="w-full max-h-66 object-cover rounded-t-lg h-1/3 md:h-66" />
              <div className="py-4 px-2 md:py-6 md:px-4 text-center justify-center">
                <h3 className="text-lg font-medium text-gray-900">Naveen Madasu Portfolio</h3>
                  <p className="mt-2 text-gray-500 text-sm">Created a professional Portfolio App using React JS, HTML & CSS, and that too it is my first own project</p>
                  <button className="mt-4 px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-red-500">
                <a
                  id
                  href='https://github.com/naveen1764/My_Portfolio'
                >
          ...
          {/* <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            ...
            <img src={Project2Img} alt="Property" className="w-full max-h-66 object-cover rounded-t-lg h-1/3 md:h-66" />
               <div className="py-4 px-2 md:py-6 md:px-4 text-center justify-center">
                <h3 className="text-lg font-medium text-gray-900">Ozone3 Web App</h3>
                   <p className="mt-2 text-gray-500 text-sm">Created a professional web app for ozone3 studio using ReactJS and Tailwind CSS.</p>             
                   <button className="mt-4 px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-red-500">
                <a
                  id
                  href='https://github.com/TheMostafax/Ozone3-WebApp-ReactJs-V2'
                >
                  more info on GitHub    <FiArrowRight className="mr-2 inline-block" />
                </a>
                </button>
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            ...
            <img src={Project3Img} alt="Property" className="w-full max-h-66 object-cover rounded-t-lg h-1/3 md:h-66" />
               <div className="py-4 px-2 md:py-6 md:px-4 text-center justify-center">
                <h3 className="text-lg font-medium text-gray-900">My Real Estate</h3>
                   <p className="mt-2 text-gray-500 text-sm">Created a professional web app about real estate using ReactJS and Tailwind CSS.</p>           
                <button className="mt-4 px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-red-500">
                <a
                  id
                  href='https://github.com/TheMostafax/My_Real_Estate'
                >
                   more info on GitHub    <FiArrowRight className="mr-2 inline-block" />
                </a>
                </button>
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            ...
            <div className="py-4 px-2 md:py-6 md:px-4 text-center justify-center">
                <h3 className="text-lg font-medium text-gray-900">My Fashion App</h3>
                  <p className="mt-2 text-gray-500 text-sm">Created a professional mobile app about fashion and clothes store using Flutter.</p>
                  <button className="mt-4 px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-red-500">
                <a
                  id
                  href='https://github.com/TheMostafax/My_Fashion_App'
                >
                  more info on GitHub    <FiArrowRight className="mr-2 inline-block" />
                </a>
                </button>
          ...
          <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            ...
            <div className="py-4 px-2 md:py-6 md:px-4 text-center justify-center">
                <h3 className="text-lg font-medium text-gray-900">My Kingdom Academy</h3>
                   <p className="mt-2 text-gray-500 text-sm">Created a professional web app for an academy which offers courses using NextJS.</p>
                   <button className="mt-4 px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-red-500">
                <a
                  id
                  href='https://github.com/TheMostafax/My-Kingdom-Academy'
                >
                  more info on GitHub    <FiArrowRight className="mr-2 inline-block" />
                </a>
                </button>
           ...
           <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            ...
            <div className="py-4 px-2 md:py-6 md:px-4 text-center justify-center">
               <h3 className="text-lg font-medium text-gray-900">My Mario Game</h3>
                  <p className="mt-2 text-gray-500 text-sm">Created a professional mario game using C# and multimedia techniques.</p>
                   <button className="mt-4 px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-red-500">
                <a
                  id
                  href='https://github.com/TheMostafax/My_Mario_Game'
                >
                   more info on GitHub    <FiArrowRight className="mr-2 inline-block" />
                </a>
                </button>
           ...
           <div className="shadow-md shadow-[#040c16] hover:scale-110 duration-500">
            ...
            <div className="py-4 px-2 md:py-6 md:px-4 text-center justify-center">
               <h3 className="text-lg font-medium text-gray-900">My Art Gallery</h3>
                  <p className="mt-2 text-gray-500 text-sm">Created a simple art gallery mobile app to show my artworks using Flutter.</p>
                   <button className="mt-4 px-4 py-2 bg-blue-900 text-white rounded-md hover:bg-red-500">
                <a
                  id
                  href='https://github.com/TheMostafax/My_Art_Gallery'
                >
                   more info on GitHub    <FiArrowRight className="mr-2 inline-block" />
                </a>
                </button>
