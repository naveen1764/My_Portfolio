    ...
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="w-full md:w-auto mb-4 md:mb-0">
          <h2 className="font-bold text-lg mb-2">Social Media</h2>
            <a href="https://www.instagram.com/thisismostafaxx__/" className="inline-block mr-4">
            <FaInstagram className="inline-block mr-2" />
              Instagram
            </a>
            <a href="https://www.linkedin.com/in/mostafa-hassan-5a3450284/" className="inline-block mr-4">
            <FaLinkedin className="inline-block mr-2" />
              LinkedIn
            </a>
            <a href="https://github.com/TheMostafax" className="inline-block">
